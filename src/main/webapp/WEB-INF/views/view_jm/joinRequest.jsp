		...
		<div class="contents">
			...
			<div class="content">
				<ul class="join_step">
					...
					<li><img src="../images/join/certInfo_after.png"><span>자격인증</span></li>
					<li><img src="../images/join/joinInfo_after.png"><span>회원정보 입력</span></li>
					<li><img src="../images/join/joinOk.png"><span>가입신청</span></li>
				</ul>
			</div>
